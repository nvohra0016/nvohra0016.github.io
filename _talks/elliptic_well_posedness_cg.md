...
\begin{equation}
A = \frac{1}{h}\begin{bmatrix} 1 & -1 & 0 & \dots & 0 & 0 \\ -1 & 2 & -1 & \dots & 0 & 0 \\ \vdots & \vdots & \vdots & \ddots & \vdots & \vdots \\ 0 & 0 & 0 & \dots & -1 & 1 \end{bmatrix}, \; F = \begin{bmatrix} \frac{h}{2}f(x_0) & hf(x_1) & hf(x_2) & \dots & hf(x_{M-1}) & \frac{h}{2}f(x_{M}) \end{bmatrix}^T,
\end{equation}
